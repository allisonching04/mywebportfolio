<?php
	$this_page = "graphic";
	$page_title = "Food Icon";
	$portfolio_title = "The Collection of<br>Food Icons";
?>
...
<body>
	...
	<div class="innerpage_context innerpage_gallery">
		<div class="innerpage_web_detail">
			...
			<img class="portfolio_image_bg portfolio_image_fox" src="img/graphic/foodIcon/foodIcon_featured.png">
			<div class="portfolio_paragraph body_paragraph moblie_body_paragraph">
				<p class="body_text portfolio_text">
					<span class="bold_body_text">This is a collection</span> of food icons.
				</p>
